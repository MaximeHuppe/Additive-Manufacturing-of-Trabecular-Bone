...
if level2<0.35 
    level2 = 0.35; % Threshold can be modified if needed 
end
...
% title(["Original image with the removed background ","and paraffin","Otsu threshold value:" num2str(level1)])
% 
% subplot(2,2,3)
% imshow(image__further_Improved)
% title(["Original Image with the background", "paraffin and bone marrow removed","Otsu threshold value:" num2str(level2)]);
% 
% subplot(2,2,4)
% imshow(binary_Image)
% title("Binary image")
